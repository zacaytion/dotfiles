...
set CMDS alt check clearart completion config dup duplicates edit embedart extractart fetchart fields fish ftintitle ? help imp im import info ls list miss missing mod modify mv move rm remove splupdate stats upd up update version write
...
# ------ fieldsetups for  alt -------
complete -c beet -n '__fish_beet_needs_command' -a alt -f -d 'manage alternative files'
complete -c beet -n '__fish_beet_using_command alt' -a '$FIELDS' -f -d 'fieldname'

# ------ fieldsetups for  check -------
complete -c beet -n '__fish_beet_needs_command' -a check -f -d 'compute and verify checksums'
complete -c beet -n '__fish_beet_using_command check' -a '$FIELDS' -f -d 'fieldname'
...
# ====== completions for  alt =====
complete -c beet -n '__fish_beet_using_command alt' -s h -l help -f -d 'print help'


# ====== completions for  check =====
complete -c beet -n '__fish_beet_using_command check' -s e -l external -f -d 'run external tools'
complete -c beet -n '__fish_beet_using_command check' -s a -l add -f -d 'add checksum for all files that do not already have one'
complete -c beet -n '__fish_beet_using_command check' -s u -l update -f -d 'compute new checksums and add the to the database'
complete -c beet -n '__fish_beet_using_command check' -s f -l force -f -d 'force updating the whole library or fixing all files'
complete -c beet -n '__fish_beet_using_command check' -l export -f -d 'print paths and corresponding checksum'
complete -c beet -n '__fish_beet_using_command check' -s x -l fix -f -d 'fix errors with external tools'
complete -c beet -n '__fish_beet_using_command check' -s l -l list-tools -f -d 'list available third-party used to check integrity'
complete -c beet -n '__fish_beet_using_command check' -s q -l quiet -f -d 'only show errors'
complete -c beet -n '__fish_beet_using_command check' -s h -l help -f -d 'print help'
